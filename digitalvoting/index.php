...
<body>
    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          <ul class="nav navbar-nav">
            <li><a href="feedbackc.php"><span class="subFont"><strong>Contact Us</strong></span></a></li>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            <div class="jumbotron text-center text-block" style="padding-top:260px;">
              <img src="image/Vote.jpg" alt="">
                  <h1 class="specialHead">Digital Voting System</h1>
                  <p class="normalFont">Safe . Reliable . Secure . Fast </p>

                  <a href="vault.php" class="btn btn-primary btn-md specialHead"><i class="fa fa-tag" aria-hidden="true"></i> Cast Your Vote</a>
            </div>
          </div>
        </div>
      </div>
